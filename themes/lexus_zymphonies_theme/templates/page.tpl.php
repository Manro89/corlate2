    ...
    <div class="full-wrap clearfix">
      <nav id="main-menu"  role="navigation">
        ...
        <div class="menu-navigation-container">
         <img src="" alt="">
         <p class="contact-number">+0123 456 70 90</p>
        </div>
        <div class="clear"></div>
      </nav>
      <!-- Social Links -->
      ...
      <?php if (theme_get_setting('social_links')): ?>
        <span class="social-icons">
         <ul>
          ...
          <li><a class="dribble" href="<?php echo theme_get_setting('dribble_profile_url'); ?>" target="_blank" rel="me"><i class="dr dr-dribble"></i></a></li>
